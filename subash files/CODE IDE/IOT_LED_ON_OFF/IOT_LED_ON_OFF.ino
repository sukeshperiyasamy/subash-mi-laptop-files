...
client.print("YEELOW LED <button onclick=\"location.href='/A'\">HIGH</button>");
            client.println(" <button onclick=\"location.href='/B'\">LOW</button><br>");

            client.print("GREEN LED <button onclick=\"location.href='/C'\">HIGH</button>");
            client.println(" <button onclick=\"location.href='/D'\">LOW</button><br>");
